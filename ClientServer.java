...
public class ClientServer {
	...
	public static void main(String [] args){
		...
		Object selection = JOptionPane.showInputDialog(null, "Login as : ", "STARK CHAT APP", JOptionPane.QUESTION_MESSAGE, null, selectioValues, initialSection);
		if(selection.equals("Server")){
                   String[] arguments = new String[] {};
			new ServerSync().main(arguments);
